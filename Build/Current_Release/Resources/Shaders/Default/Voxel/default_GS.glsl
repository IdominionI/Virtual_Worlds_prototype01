...
void main() {
	...
	vec4 dx = mvpMatrix[0] / 2.0f * gs_in_parameters_in[0].float_parameters[1].float_value;
    vec4 dy = mvpMatrix[1] / 2.0f * gs_in_parameters_in[0].float_parameters[1].float_value;
    vec4 dz = mvpMatrix[2] / 2.0f * gs_in_parameters_in[0].float_parameters[1].float_value;
