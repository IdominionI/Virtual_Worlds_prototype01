#include "voxel_hcp_render.h"
	...
	bool voxel_hcp_render_class::define_voxel_hcp_render_object(scene_node_class <render_object_class> *entity_render_object,voxel_hcp_object_class *voxel_hcp_object, log_panel_class* log_panel) {
	...
	bool voxel_hcp_render_class::update_geometry_vertex_cloud_data(point_cloud3DD_class *voxel_hcp_cloud,scene_node_class <render_object_class> *entity_render_object, log_panel_class *log_panel) {
		if (voxel_hcp_cloud == NULL) {
...
//printf("voxel_hcp_render_class :: update_geometry_vertex_cloud_data @@@@ %i\n", point_cloud_data->vertices.size());
	...
	bool voxel_hcp_render_class::define_shader_program(scene_node_class <render_object_class> *entity_render_object, log_panel_class *log_panel) {
