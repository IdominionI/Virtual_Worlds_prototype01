...
bool hcp_automata_rules_widget_class::rules_manager(std::vector<voxel_hcp_automata_byte_rule_struct_type>& automata_rules) {
	...
	for (int j = 0; j < automata_rules.size(); j++) {
		...
		if (ImGui::BeginPopupModal(w_id.c_str(), NULL, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoDocking))
		{
			...
			if (modal_copy) {
				for (int i = 0; i < NUMBER_HCP_NEIGHBOURS; i++) {
					...
					case lower_rule_condition_enum_type::ignore: lower_rule[i] = 0; break;
					case lower_rule_condition_enum_type::LT: lower_rule[i] = 1; break;
					case lower_rule_condition_enum_type::LTEQ: lower_rule[i] = 2; break;
					}

					switch (neighbours_rule_condition[i].upper_rule) {
					case  upper_rule_condition_enum_type::ignore: upper_rule[i] = 0; break;
					case  upper_rule_condition_enum_type::EQ:     upper_rule[i] = 1; break;
					case  upper_rule_condition_enum_type::NE:     upper_rule[i] = 2; break;
					case  upper_rule_condition_enum_type::LT:     upper_rule[i] = 3; break;
					case  upper_rule_condition_enum_type::LTEQ:   upper_rule[i] = 4; break;
					}
				}
				self_rule_condition = automata_rule->voxel_self_rule_condition;

				switch (self_rule_condition.lower_rule) {
				case lower_rule_condition_enum_type::ignore: self_lower_rule = 0; break;
				case lower_rule_condition_enum_type::LT: self_lower_rule = 1; break;
				case lower_rule_condition_enum_type::LTEQ: self_lower_rule = 2; break;
				}

				switch (self_rule_condition.upper_rule) {
				case  upper_rule_condition_enum_type::ignore: self_upper_rule = 0; break;
				case  upper_rule_condition_enum_type::EQ:     self_upper_rule = 1; break;
				case  upper_rule_condition_enum_type::NE:     self_upper_rule = 2; break;
				case  upper_rule_condition_enum_type::LT:     self_upper_rule = 3; break;
				case  upper_rule_condition_enum_type::LTEQ:   self_upper_rule = 4; break;
				}
			...
			for (int i = 0; i < NUMBER_HCP_NEIGHBOURS + 1; i++) {
				...
				if (i < NUMBER_HCP_NEIGHBOURS) {
					...
					ImGui::SetNextItemWidth(40); ImGui::InputInt(r_id.c_str(), &neighbours_rule_condition[i].lower_rule_value, 0);
					...
					ImGui::SameLine(); r_id = rid_prefix + std::to_string(i * 10 + 6); ImGui::SetNextItemWidth(40); ImGui::InputInt(r_id.c_str(), &neighbours_rule_condition[i].upper_rule_value, 0);
					// ************************** Added increment/decrement buttons ********************************
					...
					r_id = rid_prefix + std::to_string(i); ImGui::SetNextItemWidth(40); ImGui::InputInt(r_id.c_str(), &self_rule_condition.lower_rule_value, 0);
					// ************************** Added increment/decrement buttons ********************************
					float t_height = ImGui::GetTextLineHeight();
					float b_height = ImGui::GetTextLineHeight() / 2.0f;
					float xpos = ImGui::GetCursorPosX(); float ypos = ImGui::GetCursorPosY();// These x,y positions seem to be strangely aligned with the diplayed widgets
					...
					// --------------------------------------------------
					ImGui::SameLine(); r_id = rid_prefix + std::to_string(i * 10 + 6); ImGui::SetNextItemWidth(40); ImGui::InputInt(r_id.c_str(), &self_rule_condition.upper_rule_value, 0);
					// ************************** Added increment/decrement buttons ********************************
					t_height = ImGui::GetTextLineHeight();
					b_height = ImGui::GetTextLineHeight() / 2.0f;
					xpos = ImGui::GetCursorPosX(); ypos = ImGui::GetCursorPosY();// These x,y positions seem to be strangely aligned with the diplayed widgets
			...
			if (ex_button("Accept:::vaunrab", x_pos + 230, y_pos + 30, 50, 20)) {
				...
				for (int i = 0; i < NUMBER_HCP_NEIGHBOURS; i++) {
					switch (lower_rule[i]) {
					case 0: neighbours_rule_condition[i].lower_rule = lower_rule_condition_enum_type::ignore; break;
					case 1: neighbours_rule_condition[i].lower_rule = lower_rule_condition_enum_type::LT;     break;
					case 2: neighbours_rule_condition[i].lower_rule = lower_rule_condition_enum_type::LTEQ;   break;
					}

					switch (upper_rule[i]) {
					case 0: neighbours_rule_condition[i].upper_rule = upper_rule_condition_enum_type::ignore; break;
					case 1: neighbours_rule_condition[i].upper_rule = upper_rule_condition_enum_type::EQ;     break;
					case 2: neighbours_rule_condition[i].upper_rule = upper_rule_condition_enum_type::NE;     break;
					case 3: neighbours_rule_condition[i].upper_rule = upper_rule_condition_enum_type::LT;     break;
					case 4: neighbours_rule_condition[i].upper_rule = upper_rule_condition_enum_type::LTEQ;   break;
					}
				...
				case 0: self_rule_condition.lower_rule = lower_rule_condition_enum_type::ignore; break;
				case 1: self_rule_condition.lower_rule = lower_rule_condition_enum_type::LT;     break;
				case 2: self_rule_condition.lower_rule = lower_rule_condition_enum_type::LTEQ;   break;
				}

				switch (self_upper_rule) {
				case 0: self_rule_condition.upper_rule = upper_rule_condition_enum_type::ignore; break;
				case 1: self_rule_condition.upper_rule = upper_rule_condition_enum_type::EQ;     break;
				case 2: self_rule_condition.upper_rule = upper_rule_condition_enum_type::NE;     break;
				case 3: self_rule_condition.upper_rule = upper_rule_condition_enum_type::LT;     break;
				case 4: self_rule_condition.upper_rule = upper_rule_condition_enum_type::LTEQ;   break;
				}

				automata_rule->voxel_self_rule_condition = self_rule_condition;
				modal_copy = true;
				ImGui::CloseCurrentPopup();
			}
			ImGui::EndPopup();
		...
		text("Rule     Start    Stop   Activate", 50.0f, float(j) * 65.0f + 35.0f);
		ImGui::SetCursorPosX(50); ImGui::SetCursorPosY(55.0f + float(j) * 65.0f);
		...
		if (ImGui::ButtonEx(w_id.c_str(), ImVec2(15, b_height + 3))) {
			if (automata_rule->voxel_state < 255)
				automata_rule->voxel_state += 1;
		}
		...
		if (ImGui::ButtonEx(w_id.c_str(), ImVec2(15, b_height + 3))) {
			if (automata_rule->voxel_state > 0)
				automata_rule->voxel_state -= 1;
		}
		// *************************************************************************
...
void hcp_automata_rules_widget_class::add_rule(std::vector<voxel_hcp_automata_byte_rule_struct_type>& automata_rules) {
...
void hcp_automata_rules_widget_class::delete_rule(int var_id, std::vector<voxel_hcp_automata_byte_rule_struct_type>& automata_rules) {
