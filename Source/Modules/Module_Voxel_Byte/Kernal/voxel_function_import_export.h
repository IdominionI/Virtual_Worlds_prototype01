...
//QMessageBox::information(NULL, "", "No file name defined to save data to \n Save Static Generated Function aborted", //QMessageBox::Ok);
	...
	bool import_voxel_genereated_function(voxel_generator_parameters_struct_type &generator_parameters, std::string file_pathname) {
		if (file_pathname.size() == 0) {
...
//																 file_pathname, //QMessageBox::Ok);
	...
	bool read_expression_into_voxel_generator_parameters(std::string working_model_string,voxel_generator_parameters_struct_type &generator_parameters) {
