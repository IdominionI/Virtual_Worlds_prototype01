...
#include <Source/Editor/Main_Window/Widgets/imgui_widgets.h>
	...
	bool hex_surface_automata_rules_widget_class::rules_manager(std::vector<hex_surface_automata_rule_struct_type> &automata_rules) {
...
//printf("Accpept Rule button pressed\n");
			...
			ImGui::SetCursorPosX(50); ImGui::SetCursorPosY(55 + float(j) * 65.0f);
	...
	void hex_surface_automata_rules_widget_class::add_rule(std::vector<hex_surface_automata_rule_struct_type> &automata_rules) {
//printf("in add variabel %i\n", var_type_id);
	...
	void hex_surface_automata_rules_widget_class::delete_rule(int var_id, std::vector<hex_surface_automata_rule_struct_type> &automata_rules) {
