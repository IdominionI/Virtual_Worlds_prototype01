...
//#include <Source/Graphics_Engine/Shader/shader_parameters.h>
	...
	bool hex_shader_variables_widget_class::variables_manager(material_struct_type *hex_surface_shader_parameters) {
...
//printf("display_nodes :: entity selected: %i %i \n", current_selected_var_type_id, current_selected_var_id);
	...
	void hex_shader_variables_widget_class::add_variable(int var_type_id, material_struct_type *hex_surface_shader_parameters) {
//printf("in add variabel %i\n", var_type_id);
	...
	void hex_shader_variables_widget_class::delete_variable(int var_type_id,int var_id, material_struct_type*hex_surface_shader_parameters) {
