...
//printf("Left mouse clicked 33 %f : %f \n", nodes_context->CanvasRectScreenSpace.Min.y, nodes_context->CanvasRectScreenSpace.Max.y);
        ...
        if (current_selected_node_id == -1) {
            ...
            //globalc::set_current_selected_node_entity_type_id(INVALID_ID);//*****
           // globalc::set_current_selected_node_entity_id(INVALID_ID);//*****
        }
    }
...
//printf("selected node id : %i : %i\n", node_id, current_selected_node_id);
        ...
        //globalc::set_current_selected_node_id(-1);
        selected_node = NULL;
...
//----------------------------------------------
    ...
    void scene_node_editor_class::create_entity_node(ImVec2 click_pos) {
    ...
    void scene_node_editor_class::create_node(int entity_category, int entity_context, int entity_function, ImVec2 click_pos) {
    ...
    void scene_node_editor_class::add_hcp_voxel_node(int entity_context, int entity_function, ImVec2 click_pos) {
    ...
    void scene_node_editor_class::add_hcp_matrix_node(int entity_function, ImVec2 click_pos) {
    ...
    void scene_node_editor_class::add_hcp_voxel_node(ImVec2 click_pos) {
    ...
    void scene_node_editor_class::add_hex_surface_node(int entity_context, int entity_function, ImVec2 click_pos) {
        //printf("scene_node_editor_class::add_hcp_voxel_node:: 00000\n");
        switch (entity_context) {
    ...
    void scene_node_editor_class::add_hex_surface_node(int entity_function, ImVec2 click_pos) {
        //printf("scene_node_editor_class::add_hcp_matrix_node:: 00000\n");
        switch (entity_function) {
    ...
    void scene_node_editor_class::add_hex_surface_node(ImVec2 click_pos) {
